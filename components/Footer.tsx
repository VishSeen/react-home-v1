      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="mt-24 w-full flex flex-col md:flex-row justify-between items-center text-xs tracking-[0.15em] uppercase text-primary/60 border-t border-primary/5 pt-8">
          ...
          <div className="flex gap-12">
            <a href={PORTFOLIO_DATA.socials.linkedin} className="hover:text-primary transition-colors">LinkedIn</a>
            <a href={PORTFOLIO_DATA.socials.instagram} className="hover:text-primary transition-colors">Instagram</a>
            <a href={PORTFOLIO_DATA.socials.github} className="hover:text-primary transition-colors">GitHub</a>
          </div>
        </div>
