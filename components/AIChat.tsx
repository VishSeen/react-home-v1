  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'init',
      role: 'assistant',
      text: "Welcome. I am the digital concierge for this portfolio. How may I assist you with Mr. Seen's work today?",
    },
  ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          id: Date.now().toString(),
          role: 'assistant',
          text: 'I apologize, but I am unable to connect to the service at this moment.',
        },
      ]);
    } finally {
      setIsLoading(false);
